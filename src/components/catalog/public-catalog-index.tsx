...
export function PublicCatalogIndex({
    ...
    return (
        <div className="space-y-12 pb-20">
            {/* Hero Section */}
            <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900 via-neutral-800 to-brand-blue-hover/80">
                {/* Background pattern */}
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, white 1px, transparent 0)', backgroundSize: '24px 24px' }} />
                <div className="absolute -right-32 -top-32 h-64 w-64 rounded-full bg-brand-blue/10 blur-3xl" />
                <div className="absolute -bottom-20 -left-20 h-48 w-48 rounded-full bg-brand-blue-hover/10 blur-3xl" />

                <div className="relative px-6 py-14 sm:px-10 sm:py-16 lg:py-20">
                    <div className="max-w-3xl space-y-5">
                        <div className="inline-flex items-center gap-2 rounded-full border border-brand-blue/20 bg-brand-blue/10 px-3.5 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-brand-blue">
