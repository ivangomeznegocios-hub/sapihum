                        ...
                        <button
                            ...
                            className={`inline-flex items-center rounded-full px-4 py-2.5 text-sm font-semibold tracking-[0.01em] transition-all duration-200 ${
                                isActive
                                    ...
                                    : 'border border-brand-border bg-white text-foreground/80 hover:border-primary/30 hover:bg-white/[0.05] hover:text-foreground'
                            }`}
                        >
                            {filter.label}
                        </button>
                                ...
                                <button
                                    ...
                                    className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-all ${
                                        formatFilter === option.value
                                            ...
                                            : 'border border-brand-border bg-white text-muted-foreground hover:bg-white/[0.05] hover:text-foreground'
                                    }`}
                                >
                                    {option.label}
                                </button>
            ...
            {filteredEvents.length > 0 ? (
                ...
                <div className="rounded-3xl border-2 border-dashed border-border/40 bg-gradient-to-br from-muted/30 to-muted/10 px-6 py-20 text-center">
                    <div className="mx-auto max-w-sm space-y-4">
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-brand-border bg-brand-surface-soft text-sm font-semibold text-primary">
                            S
                        </div>
