    ...
    const cards = [
        {
            ...
            bg: 'bg-brand-yellow dark:bg-brand-yellow/30',
            border: 'border-brand-yellow dark:border-brand-yellow/50',
        },
        {
            ...
            bg: 'bg-brand-brown dark:bg-brand-brown/30',
            border: 'border-brand-brown dark:border-brand-brown/50',
        },
        {
