    ...
    const cards = [
        {
            ...
            bg: 'bg-brand-blue dark:bg-brand-blue/30',
            border: 'border-brand-blue dark:border-brand-blue/50',
        },
        {
            ...
            bg: 'bg-brand-blue-hover dark:bg-brand-blue-hover/30',
            border: 'border-brand-blue-hover dark:border-brand-blue-hover/50',
        },
        {
