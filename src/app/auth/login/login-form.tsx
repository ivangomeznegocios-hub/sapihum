...
function getAuthErrorMessage(errorCode: string | null) {
    if (errorCode === 'profile_not_found') {
        return 'Tu sesion existe, pero no encontramos tu perfil en la base de datos. Cierra sesion o completa la creacion del perfil antes de entrar al dashboard.'
    }

    if (errorCode === 'auth_callback_error') {
        return 'No pudimos completar el callback de autenticacion. Intenta iniciar sesion otra vez.'
    }
