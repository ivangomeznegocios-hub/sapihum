            ...
            <div className="max-w-md mx-auto py-12">
                <Card>
                    <CardContent className="pt-8 pb-6 text-center space-y-4">
                        <div className="mx-auto w-14 h-14 bg-brand-blue dark:bg-brand-blue/30 rounded-full flex items-center justify-center">
                            <AlertCircle className="h-7 w-7 text-brand-blue" />
                        </div>
