...
export default async function MarketingHubPage() {
    ...
    return (
        <div className="space-y-8 max-w-6xl mx-auto pb-10">
            ...
            {/* Header VIP */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-neutral-900 to-brand-blue-hover text-white p-8 sm:p-12 shadow-lg border border-brand-blue/50">
                <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 opacity-20 pointer-events-none">
                    <Sparkles className="w-96 h-96 text-brand-blue" />
                </div>

                <div className="relative z-10 max-w-3xl space-y-4">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-blue/20 text-brand-blue text-sm font-medium border border-brand-blue/30 backdrop-blur-sm">
                        <Sparkles className="h-4 w-4" />
                        Membresía Marketing Premium
                    </div>
                    <h1 className="text-3xl sm:text-5xl font-bold tracking-tight">
                        Tu equipo de marketing, <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue via-brand-blue-hover to-brand-blue-hover">
                            listo para escalar tu marca.
                        </span>
                    </h1>
                    <p className="text-brand-blue/80 text-lg max-w-2xl leading-relaxed">
                    ...
                    {/* Progress bar */}
                    <div className="pt-2">
                        <div className="flex items-center gap-3 text-sm text-brand-blue/80 mb-2">
                    ...
                    <div className="pt-4 flex flex-wrap gap-4">
                        ...
                        {supportWhatsAppUrl ? (
                            <Button variant="outline" className="border-brand-blue/50 text-white hover:bg-brand-blue/20 bg-transparent" asChild>
                            ...
                            <Button variant="outline" className="border-brand-blue/50 text-white bg-transparent opacity-60" disabled>
                                <MessageCircle className="w-4 h-4 mr-2" />
                                    ...
                                    <Card key={service.id} className="flex flex-col h-full border-neutral-200 dark:border-neutral-800 overflow-hidden group hover:shadow-md transition-all">
                                        ...
                                        <CardFooter className="pt-2 pb-4">
                                            {isPendingBrief && key === 'community_manager' ? (
                                                ...
                                                <Button variant="secondary" className="w-full justify-between text-brand-blue-hover" disabled>
