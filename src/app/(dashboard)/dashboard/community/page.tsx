...
const communityLinks = [
    ...
    },
    {
        ...
        icon: Video,
        color: 'bg-rose-100 text-brand-blue-hover dark:bg-rose-900/30 dark:text-brand-blue-hover',
    },
    {
        title: 'Ponentes',
    ...
    },
    {
        ...
        icon: BookOpen,
        color: 'bg-brand-blue/20 text-brand-blue dark:bg-brand-blue/30 dark:text-brand-blue',
    },
    {
        title: 'Newsletter',
