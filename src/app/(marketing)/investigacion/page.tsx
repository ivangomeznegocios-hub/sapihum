...
export default function InvestigacionPage() {
  return (
    <div className="flex flex-col items-center flex-1 w-full bg-background relative">
      <section className="w-full py-20 md:py-32 flex flex-col items-center text-center px-4 bg-gradient-to-br from-[#0A1628] via-[#0d2137] to-[#0A1628] text-white overflow-hidden relative">
        <div className="absolute inset-0 sapihum-grid-bg opacity-30" />
        <div className="absolute left-1/4 top-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-teal-500/10 blur-[150px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link href="/auth/register">
              <Button className="mt-4 bg-gradient-to-r from-teal-500 to-emerald-500 text-white shadow-lg">
            ...
            {[
              ...
              <div key={linea.title} className="p-6 rounded-2xl border bg-card sapihum-card-glow text-left">
                <div className="flex items-center gap-3 mb-2">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-400 font-bold text-sm">
                    {i+1}
                  </span>
